...
$id = $_GET['id'];
$select = $conn->prepare("SELECT * FROM mysystem.tb_fornecedor where cd_fornecedor=$id");
$select->execute();
$row = $select->fetch();
     ...
     <div class='modal-dialog'>
         <div class='modal-content'>
             <div class='modal-header'>
                 ...
                 <button type='button' onclick='window.location.href=`../../views/consultaFornecedor.php`'  class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
             </div>
             <form method='POST'>
             <div class='mb-3'>
             <label for='inputCnpj' class='form-label'>CNPJ :</label>
             <input required type='number' name='cnpj' value='" . $row['nr_cnpj'] . "' class='form-control' id='inputCnpj' aria-describedby='CnpjHelp'>
             <div id='CnpjHelp' class='form-text'>Ex.: 111.111.111-11</div>
         </div>
         <div class='mb-3'>
             <label for='inputnmEmpresa' class='form-label'>Empresa :</label>
             <input required type='text'  value='" . $row['nm_empresa'] . "'   name='empresa' class='form-control' id='inputnmEmpresa' aria-describedby='nmEmpresaHelp'>
             <div id='nmEmpresaHelp' class='form-text'>Ex.: 11.111.111-1</div>
         </div>
         <div class='mb-3'>
             <label for='inputProduto' class='form-label'>Produto :</label>
             <input required  value='" . $row['tp_produto'] . "'  type='text' name='produto' class='form-control' id='inputProduto' aria-describedby='produtoHelp'>
             <div id='produtoHelp' class='form-text'>Ex.: 11.111.111-1</div>
         </div>
         ...
         <div class='mb-3'>
             ...
             <input required type='number'  value='" . $row['nr_endereco'] . "'  name='endereco' class='form-control' id='inputNrEnd' aria-describedby='nrEndHelp'>
...
if (!empty($_POST)) {
    ...
    USE mySystem;
     ...
     UPDATE tb_fornecedor SET nr_cnpj = :cnpj, nm_empresa = :empresa, tp_produto = :produto, nr_cep = :cep, nr_endereco = :endereco , nm_pais = :pais, nr_celular = :tel, nm_email = :email WHERE cd_fornecedor = $id;");
        ...
        echo "<script>window.location.href = '../../views/consultaFornecedor.php';</script>";
