...
<div class="container-fluid">
    ...
    <form method="POST">
        <div class="mb-3">
            ...
            <input required type="number" max="18" name="cnpj" class="form-control" id="inputCnpj" aria-describedby="CnpjHelp">
            <div id="CnpjHelp" class="form-text">Ex.: XX.XXX.XXX/0001-XX</div>
        </div>
        <div class="mb-3">
            <label for="inputnmEmpresa" class="form-label">Empresa :</label>
            <input required type="text" name="empresa" class="form-control" id="inputnmEmpresa" aria-describedby="nmEmpresaHelp">
            <div id="nmEmpresaHelp" class="form-text">Ex.: Clear Cloud Software</div>
        </div>
        <div class="mb-3">
            <label for="inputProduto" class="form-label">Categoria De Produtos :</label>
            <input required type="text" name="produto" class="form-control" id="inputProduto" aria-describedby="produtoHelp">
            <div id="produtoHelp" class="form-text">Ex.: Frutas</div>
        </div>
...
try {
    ...
    if (!empty($_POST)) {
        ...
        try {
            $stmt = $conn->prepare("
            USE mySystem;
            INSERT INTO tb_fornecedor (nr_cnpj, nm_empresa, tp_produto, nr_cep, nr_endereco, nm_pais, nr_celular, nm_email)
                VALUES (:cnpj, :empresa, :produto, :cep, :endereco, :pais, :tel, :email)");
